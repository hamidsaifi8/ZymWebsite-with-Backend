  ...
  return (
    <div>
      ...
      <p className="font-medium text-gray-300">
        ...
        molestias excepturi, ipsam alias dolor, in debitis labore rem, non
        obcaecati eos vel quos. Minus cumque eum facere molestiae iusto
        adipisci!
      </p>
      <div className="grid 2xl:grid-cols-2 2xl:gap-y-8">
        <div>
          <h4 className={headingStyles}>Delhi, India</h4>
        ...
        <div>
          ...
          <a
            href="consultwithhamid@gmail.com"
            className="block font-medium text-gray-300"
          >
            consultwithhamid@gmail.com
          </a>
        </div>
        <div>
